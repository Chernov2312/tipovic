...
"""
  ...
  26_groupbox.py - группа TGroupBox
...
rgbRect = TLabel(gb, text="", width =15, height = 3 )
rgbRect.position = (105, 35)

rEdit = TEdit(gb, font=fSans, width=5)
rEdit.position = (45, 5)
rEdit.text = "123"

gEdit = TEdit(gb, font=fSans, width=5)
gEdit.position = (45, 30)
gEdit.text = "56"

bEdit = TEdit(gb, font=fSans, width=5)
bEdit.text = "80"
